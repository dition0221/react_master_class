...
export default function Footer() {
  const [serviceValue, setServiceValue] = useState("서비스 코드");
  const serviceBtnClick = () => setServiceValue("012-345");
  ...
  return (
    <Wrapper>
      ...
      <ServiceBtn onClick={serviceBtnClick}>{serviceValue}</ServiceBtn>
      <Info>
        <span>
          넷플릭스서비스코리아 유한회사 통신파매업신고번호:
